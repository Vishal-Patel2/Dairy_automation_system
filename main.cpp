...
public:
    void getdata()//for inputing the information
    {
    ...
    void putdata();//for displaying the information
};

void info::putdata()
{
    float fat_rate = 8.43, total;
    float fat_t = (fat * fat_rate);
    total = (fat * fat_rate) * milk;
    system("cls");
    cout << "\n\tYOUR BILL-";
    cout << "\n\t\t  ====================================";
    cout << "\n\t\t|          LAKSHMI Milk Dairy Store         |" << endl;
...
void menu()
{
    ...
    cout << "\n\n\t\tWelcome to  LAKSHMI Milk Dairy Store     [ " << user << " ]";
...
{
    system("cls");
    cout << "\n\n\t\tAbout LAKSHMI milk dairy";
    cout << "\n\t\t ============================================";
    cout << "\n\t\t|  LAKSHMI milk dairy is a leading dairy      |";
